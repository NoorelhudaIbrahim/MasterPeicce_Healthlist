    ...
    <div class="prod-container">
      <?php
        ...
        foreach ($products as $product) {
          ...
          echo '<img src="./admin/uploaded_img/product-' . $product['product_id'] . '.jpg" alt="">';
          echo '<div class="text">';
          echo '<span class="tag">' . $category['category_name'] . '</span>';
          ...
          <div class="cat1 ">
            ...
            <?php
              ...
              foreach ($categories as $category) {
                ...
                echo '<span class="text">' . $category['category_name'] . '</span>';
